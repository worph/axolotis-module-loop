...
__export(src_exports, {
  ...
  AnimationFrameLoopFactory: () => AnimationFrameLoopFactory,
  AnimationFrameLoopFactoryName: () => AnimationFrameLoopFactoryName,
  AxLoopModule: () => AxLoopModule,
  FrameLoopManager: () => FrameLoopManager,
  FrameLoopManagerName: () => FrameLoopManagerName,
  SUFFIX_DELIMITER: () => SUFFIX_DELIMITER,
  SetIntervalLoop: () => SetIntervalLoop,
  SetIntervalLoopFactory: () => SetIntervalLoopFactory,
  SetIntervalLoopFactoryName: () => SetIntervalLoopFactoryName,
  SetTimeoutLoop: () => SetTimeoutLoop,
  SetTimeoutLoopFactory: () => SetTimeoutLoopFactory,
  SetTimeoutLoopFactoryName: () => SetTimeoutLoopFactoryName,
  TimeLogger: () => TimeLogger,
  TimeLoggerName: () => TimeLoggerName
});
module.exports = __toCommonJS(src_exports);
var import_inversify6 = __toESM(require_inversify(), 1);

// src/Identifier.ts
var FrameLoopManagerName = Symbol.for("FrameLoopManagerName");
var AnimationFrameLoopFactoryName = Symbol.for("AnimationFrameLoopFactoryName");
var SetIntervalLoopFactoryName = Symbol.for("SetIntervalLoopFactoryName");
var SetTimeoutLoopFactoryName = Symbol.for("SetTimeoutLoopFactoryName");
var TimeLoggerName = Symbol.for("TimeLoggerName");

// src/services/loop/AnimationFrameLoopFactory.ts
var import_inversify = __toESM(require_inversify(), 1);
var AnimationFrameLoop = class {
  constructor(callback, timeLogger) {
...
var AnimationFrameLoopFactory = class {
  constructor(timeLogger, frameLoop) {
    this.timeLogger = timeLogger;
...
AnimationFrameLoopFactory = __decorateClass([
  (0, import_inversify.injectable)(),
  __decorateParam(0, (0, import_inversify.inject)(TimeLoggerName)),
  __decorateParam(1, (0, import_inversify.inject)(FrameLoopManagerName))
], AnimationFrameLoopFactory);
...
FrameLoopManager = __decorateClass([
  (0, import_inversify2.injectable)()
], FrameLoopManager);

// src/services/loop/SetIntervalLoopFactory.ts
var import_inversify3 = __toESM(require_inversify(), 1);
var SetIntervalLoop = class {
  constructor(callback, timeLogger, intervalMs) {
    this.callback = callback;
    this.timeLogger = timeLogger;
...
var SetIntervalLoopFactory = class {
  constructor(timeLogger, frameLoop) {
    this.timeLogger = timeLogger;
    this.frameLoop = frameLoop;
  }
  create(name, callback, intervalMs = 0) {
...
SetIntervalLoopFactory = __decorateClass([
  (0, import_inversify3.injectable)(),
  __decorateParam(0, (0, import_inversify3.inject)(TimeLoggerName)),
  __decorateParam(1, (0, import_inversify3.inject)(FrameLoopManagerName))
], SetIntervalLoopFactory);

// src/services/loop/SetTimeoutLoopFactory.ts
var import_inversify4 = __toESM(require_inversify(), 1);
var SetTimeoutLoop = class {
  constructor(callback, timeLogger, timeoutMs) {
    this.callback = callback;
    this.timeLogger = timeLogger;
...
var SetTimeoutLoopFactory = class {
  constructor(timeLogger, frameLoop) {
    this.timeLogger = timeLogger;
    this.frameLoop = frameLoop;
  }
  create(name, callback, timeoutMs = 0) {
...
SetTimeoutLoopFactory = __decorateClass([
  (0, import_inversify4.injectable)(),
  __decorateParam(0, (0, import_inversify4.inject)(TimeLoggerName)),
  __decorateParam(1, (0, import_inversify4.inject)(FrameLoopManagerName))
], SetTimeoutLoopFactory);
...
var AxLoopModule = class {
  getModule() {
    return new import_inversify6.ContainerModule((bind) => {
